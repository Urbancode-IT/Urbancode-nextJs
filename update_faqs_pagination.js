...
const destinations = [
    {
        ...
        faqs: [
            ...
            { q: "What is OPT and CPT?", a: "Optional Practical Training (OPT) allows graduates to work for 1-3 years. Curricular Practical Training (CPT) allows you to do internships during your studies." },
            { q: "Are scholarships available for international students in the USA?", a: "Yes, many universities offer merit-based and need-based scholarships for international students, which can significantly reduce tuition costs." },
            { q: "How much does it cost to live in the USA?", a: "Living expenses vary greatly by state and city, but generally range from $10,000 to $18,000 per year, covering accommodation, food, travel, and personal expenses." },
            { q: "What is a GPA and why is it important?", a: "GPA (Grade Point Average) is a number that represents your academic performance. US universities use it to evaluate your eligibility for admission and scholarships." },
            { q: "Do I need SAT or GRE scores?", a: "Many universities have become test-optional, but top-tier institutions may still require SAT (for bachelors) or GRE/GMAT (for masters) scores. It depends on the specific university." }
        ]
    },
    {
        id: "uk",
        ...
        faqs: [
            ...
            { q: "Is healthcare free for international students?", a: "International students pay an Immigration Health Surcharge (IHS) during their visa application, which gives them access to free medical treatment through the NHS." },
            { q: "What is UCAS?", a: "UCAS (Universities and Colleges Admissions Service) is the centralized platform used to apply for undergraduate degrees at all UK universities." },
            { q: "Are UK degrees recognized globally?", a: "Yes, UK degrees are highly respected and recognized by employers, universities, and governments worldwide." },
            { q: "Can I bring my dependents to the UK?", a: "Currently, only students enrolled in postgraduate research programs (like a PhD) or government-sponsored students can bring dependents on a student visa." }
        ]
    },
    {
        id: "canada",
        ...
        faqs: [
            ...
            { q: "What is the Student Direct Stream (SDS)?", a: "The SDS is an expedited study permit processing program for legal residents of certain countries (like India, China, etc.) if they meet specific financial and language requirements." },
            { q: "Do I need French to study in Canada?", a: "No, English is the primary language of instruction in most provinces except Quebec. However, knowing French can be an asset for immigration." },
            { q: "Are Canadian degrees recognized globally?", a: "Yes, Canadian degrees are equivalent to those from the US and Commonwealth countries and are highly respected globally." },
            { q: "Can my spouse work while I study?", a: "Yes, the spouse or common-law partner of an international student can apply for an open work permit, allowing them to work full-time in Canada." }
        ]
    },
    {
        id: "australia",
        ...
        faqs: [
            ...
            { q: "What is the Group of Eight (Go8)?", a: "The Go8 is a coalition of Australia's leading research-intensive universities, known for their prestige and high global rankings." },
            { q: "Are pathway programs available?", a: "Yes, many institutions offer foundation or diploma pathway programs for students who don't meet the direct entry requirements for a bachelor's degree." },
            { q: "What is the cost of living like in Australia?", a: "The cost of living varies by city, but the government requires students to show access to around AUD 24,500 per year for living expenses." },
            { q: "Do I need IELTS for an Australian student visa?", a: "Yes, an English proficiency test like IELTS, PTE, or TOEFL is mandatory for securing an Australian student visa." }
        ]
    },
    {
        id: "germany",
        ...
        faqs: [
            ...
            { q: "What is the difference between a University and a Fachhochschule (UAS)?", a: "Universities focus more on theoretical knowledge and research, while Fachhochschulen (Universities of Applied Sciences) focus on practical training and industry connections." },
            { q: "Can I work part-time while studying?", a: "Yes, international students from outside the EU can work up to 120 full days or 240 half days per year." },
            { q: "Is it difficult to find accommodation?", a: "Student dorms are affordable but limited. Many students live in shared apartments (WGs). It's advised to start looking for accommodation early." },
            { q: "What are the intake seasons in Germany?", a: "The primary intake is the Winter semester (starting in October), with a secondary Summer semester (starting in April) available for some programs." }
        ]
    },
    {
        id: "ireland",
        ...
        faqs: [
            ...
            { q: "Do I need a visa to study in Ireland?", a: "Non-EU students require a student visa to study in Ireland. You must have a confirmed acceptance from an Irish institution before applying." },
            { q: "Are Irish degrees recognized internationally?", a: "Yes, Ireland is part of the Bologna Process, and its degrees are globally recognized and respected by employers worldwide." },
            { q: "What is the cost of studying in Ireland?", a: "Tuition typically ranges from €10,000 to €25,000 per year, depending on the course. Living costs range from €9,000 to €14,000 annually." },
            { q: "Are scholarships available in Ireland?", a: "Yes, the Irish government and individual universities offer various scholarships for international students, such as the Government of Ireland International Education Scholarship." }
        ]
    },
    {
        id: "new-zealand",
        ...
        faqs: [
            ...
            { q: "Can I work while studying?", a: "Yes, international students can generally work up to 20 hours a week during term time and full-time during scheduled holidays." },
            { q: "What is the cost of living in New Zealand?", a: "You need to show you have at least NZD 20,000 per year to support yourself while studying in New Zealand." },
            { q: "Are scholarships available?", a: "Yes, the New Zealand government and universities offer various scholarships specifically for international students." },
            { q: "Do I need health insurance?", a: "Yes, international students must have approved medical and travel insurance for the duration of their visa." }
        ]
    },
    {
        id: "singapore",
        ...
        faqs: [
            ...
            { q: "What is the Tuition Grant Scheme?", a: "The Ministry of Education offers Tuition Grants to international students to subsidize tuition fees. In exchange, students sign a bond to work in Singapore for three years after graduation." },
            { q: "Can I work part-time while studying?", a: "International students at approved institutions can work up to 16 hours a week during term time and full-time during vacations, subject to certain conditions." },
            { q: "Are scholarships available?", a: "Yes, Singapore universities and external organizations offer merit-based scholarships that can significantly reduce tuition costs." },
            { q: "Do I need a student pass?", a: "Yes, all international students require a Student's Pass to pursue full-time studies in Singapore." }
        ]
    }
];
...
const StudyIn${dest.id.replace('-', '').toUpperCase()} = () => {
    ...
    return (
        <div className="study-abroad-container bg-light min-vh-100 pb-5">
                ...
                <div className="container">
                    <div className="row align-items-center g-5">
                        <div className="col-lg-7">
                            <h2 className="fw-bold text-dark mb-4" style={{ fontSize: '2.5rem' }}>Begin Your Journey in <span className="text-success">${dest.name}</span></h2>
            ...
            <section className="section-padding py-5 bg-white">
                <div className="container">
                    <div className="row g-5 align-items-center">
                        <div className="col-lg-7">
                            <h2 className="fw-bold text-dark mb-4">Key Advantages of <span className="text-success">${dest.name}</span></h2>
                        ...
                        <div className="col-lg-5">
                            <div className="card border-0 rounded-4 shadow-sm" style={{ backgroundColor: '#fcf6e3' }}>
                                <div className="card-body p-4 p-lg-5 text-center">
                                    <h4 className="fw-bold mb-4 text-dark">Your Pathway to Success in ${dest.name}</h4>
            ...
            <section className="section-padding py-5 bg-white">
                <div className="container" style={{ maxWidth: '850px' }}>
                    <div className="text-center mb-5">
                        <h3 className="fw-bold text-dark mb-2">Got Questions? We've Got Answers</h3>
                        <p className="text-muted">Find quick answers to common queries about studying in ${dest.name}</p>
                    </div>
                    ...
                    <div className="faq-container">
                        <AnimatePresence mode="wait">
                            ...
                            >
                                {displayedFaqs.map((faq, idx) => {
                                    ...
                                    return (
                                        <div key={actualIndex} className="faq-glass-box mb-4">
                                            <div 
                                            ...
                                            >
                                                ...
                                                <div className="text-success flex-shrink-0 align-self-start mt-1 bg-white shadow-sm rounded-circle d-flex align-items-center justify-content-center" style={{ width: '32px', height: '32px' }}>
                                                    {openFaq === actualIndex ? <FaMinus size={14} /> : <FaPlus size={14} />}
                                                </div>
                                            </div>
                                            <AnimatePresence>
                                                {openFaq === actualIndex && (
                                                    ...
                                                    >
                                                        <div className="px-4 pb-4 pt-1">
                                                            <div className="pt-3 border-top border-success border-opacity-25">
                        ...
                        {totalPages > 1 && (
                            <div className="d-flex justify-content-center align-items-center gap-4 mt-5">
                                <button 
                                    className={\`btn rounded-circle shadow-sm \${faqPage === 0 ? 'btn-light text-muted' : 'btn-success text-white'}\`}
                                ...
                                <button 
                                    className={\`btn rounded-circle shadow-sm \${faqPage === totalPages - 1 ? 'btn-light text-muted' : 'btn-success text-white'}\`}
            ...
            {/* Inline styles for FAQ Glass Effect */}
            <style jsx>{\`
                .faq-glass-box {
                    background: linear-gradient(135deg, rgba(0, 181, 111, 0.05) 0%, rgba(0, 181, 111, 0.12) 100%);
                ...
                .faq-glass-box:hover {
                    box-shadow: 0 10px 25px rgba(0, 181, 111, 0.15);
                    border-color: rgba(0, 181, 111, 0.4);
...
`;
    ...
    console.log(`Rewritten page for ${dest.name} with advanced FAQs and styling`);
});
