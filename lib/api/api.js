...
export const submitInternshipApplication = async (formData) => {
  try {
    const response = await fetchWithTimeout(`${BASE_URL}/api/send-email/internship`, {
      method: "POST",
...
export const submitMentorApplication = async (formData) => {
  try {
    const response = await fetchWithTimeout(`${BASE_URL}/api/send-email/mentor`, {
      method: "POST",
      headers: { "Content-Type": "application/json" },
      body: JSON.stringify(formData),
    });
...
export const sendContactMessage = async (formData) => {
    try {
      const response = await fetchWithTimeout(`${BASE_URL}/api/send-email/contact`, {
        method: "POST",
        headers: { "Content-Type": "application/json" },
        body: JSON.stringify(formData),
      });
...
export const submitEnquiryForm = async (formData) => {
    try {
      const response = await fetchWithTimeout(`${BASE_URL}/api/send-email/course-enquiry`, {
        method: "POST",
        headers: { "Content-Type": "application/json" },
        body: JSON.stringify(formData),
      });
...
export const submitProjectEnquiryForm = async (formData) => {
    try {
      const response = await fetchWithTimeout(`${BASE_URL}/api/send-email/project-enquiry`, {
        method: "POST",
        headers: { "Content-Type": "application/json" },
        body: JSON.stringify(formData),
      });
