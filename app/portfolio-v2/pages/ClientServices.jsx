...
const ClientServices = () => {
  return (
    <section className="client-services pf-section" id="services">
      <div className="services-container">
        <div className="services-header pf-section-head">
          <h2>
            Our <span className="text-green">Services</span>
          </h2>
        </div>

        <MobileAutoSlider className="services-grid" ariaLabel="Our services">
          {SERVICES.map((s) => (
            <div key={s.id} className="service-card pf-shine-card">
