    ...
    courses: [
      {
        ...
        pageTitle: "AI Software Engineering Certification Program (6 Months)",
        pageTitleLines: [
        ...
        whatYouLearnData: [
          {
            ...
            desc: "Build production UIs with HTML5, CSS3, Bootstrap, JavaScript, ES6+, and React.",
            icon: "bi bi-window-stack",
          },
          {
            title: "Develop Secure Backend APIs",
            desc: "Create REST APIs with Node.js, Express, MongoDB, Mongoose, JWT, and role-based access.",
            icon: "bi bi-server",
          },
          {
            title: "Integrate Payments & API Tooling",
            desc: "Document APIs with Postman and Swagger, and integrate Stripe and Razorpay payment flows.",
            icon: "bi bi-credit-card",
          },
          {
            title: "Deploy on AWS",
            desc: "Ship fullstack apps using Amazon EC2, S3 hosting, environment variables, and monitoring.",
            icon: "bi bi-cloud-upload",
          },
          {
            title: "Build React Native Mobile Apps",
            desc: "Create cross-platform mobile experiences with navigation, auth, storage, API integration, and release builds.",
            icon: "bi bi-phone",
          },
          {
            title: "Think Like a Software Engineer",
            desc: "Apply system architecture, end-to-end flows, and security best practices across 13 mini projects.",
            icon: "bi bi-diagram-3",
          },
        ],
        batches: [
