...
export async function POST(req) {
  try {
    ...
    if (displayName && !displayName.includes(' ') && displayName.length > 15) {
    ...
    if ((displayName && consonantMashRegex.test(displayName)) || (interest && interest !== 'No message provided' && consonantMashRegex.test(interest))) {
