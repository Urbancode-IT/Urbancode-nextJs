    ...
    return (
        <div className="responses-manager-container">
            ...
            <style jsx>{`
                ...
                .feedback-sub-card { background: #fff; border: 1px solid #f1f5f9; border-radius: 20px; padding: 30px; margin-bottom: 20px; }
                ...
                .btn-close-text { background: transparent; border: none; color: #64748b; font-weight: 700; cursor: pointer; font-size: 1rem; }
                .btn-print-premium { background: #17944d; color: white; border: none; padding: 14px 32px; border-radius: 14px; font-weight: 800; display: flex; align-items: center; gap: 10px; cursor: pointer; box-shadow: 0 4px 12px rgba(23, 148, 77, 0.2); }
...
>>>>>>> 529151a8ee33227e032f751428e246f87f5ab3fd
        </div >
    );
};
