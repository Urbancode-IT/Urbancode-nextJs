    ...
    const faqs = [
        {
                ...
                "a": "Yes, most public universities in Germany do not charge tuition fees for bachelor's and many master's programs, even for international students. You only pay a small semester contribution."
        },
        {
                "q": "Do I need to speak German to study there?",
                "a": "While many undergraduate programs are taught in German, there is a growing number of programs (especially at the Master's level) taught entirely in English."
        },
        {
                "q": "What is a Blocked Account (Sperrkonto)?",
                "a": "A Blocked Account is a special type of bank account required for a German student visa, serving as proof that you have enough funds to support yourself for at least one year."
        },
        {
                "q": "Can I stay in Germany after graduating?",
                "a": "Yes, non-EU graduates can apply for an 18-month residence permit to look for a job related to their degree."
        },
        {
                "q": "What is the difference between a University and a Fachhochschule (UAS)?",
                "a": "Universities focus more on theoretical knowledge and research, while Fachhochschulen (Universities of Applied Sciences) focus on practical training and industry connections."
        },
        {
                "q": "Can I work part-time while studying?",
                "a": "Yes, international students from outside the EU can work up to 120 full days or 240 half days per year."
        },
        {
                "q": "Is it difficult to find accommodation?",
                "a": "Student dorms are affordable but limited. Many students live in shared apartments (WGs). It's advised to start looking for accommodation early."
        },
        {
                "q": "What are the intake seasons in Germany?",
                "a": "The primary intake is the Winter semester (starting in October), with a secondary Summer semester (starting in April) available for some programs."
        }
];
    const faqsPerPage = 5;
        ...
        <div className="study-abroad-container bg-light min-vh-100 pb-5">
            ...
            <div className="container pt-4 pb-2">
                <div className="d-flex align-items-center text-muted small fw-medium">
                    ...
                    <FaChevronRight className="mx-2" style={{ fontSize: '0.7rem' }} />
                    <span className="text-dark fw-bold">Germany</span>
                </div>
            </div>
            ...
            <div className="container mt-2 mb-5">
                <div className="country-banner-box" 
                    style={{ 
                        backgroundImage: `url('${"https://images.unsplash.com/photo-1467269204594-9661b134dd2b?auto=format&fit=crop&q=80&w=1920"}')`
                    }}>
                    <div className="country-banner-content">
                        ...
                        >
                            <h1 className="country-banner-title text-white">
                                Study in <span className="country-banner-accent">Germany</span>
                            </h1>
                ...
                <div className="container">
                    <div className="row align-items-center g-5">
                        <div className="col-lg-7">
                            <h2 className="fw-bold text-dark mb-4" style={{ fontSize: '2.5rem' }}>Begin Your Journey in <span className="text-success">Germany</span></h2>
                            <p className="text-muted mb-3" style={{ fontSize: '1.1rem', lineHeight: '1.8' }}>
                                Germany is the heart of European engineering and technology. It offers world-class education, largely tuition-free at public universities, making it an incredibly attractive destination for international students.
                            </p>
                            <p className="text-muted mb-4" style={{ fontSize: '1.1rem', lineHeight: '1.8' }}>
                                German universities provide an outstanding academic standard and are highly respected by employers worldwide. The education system strongly integrates theoretical learning with practical application, especially in STEM fields.
                            </p>
            ...
            <section className="section-padding py-5 bg-white">
                <div className="container">
                    <div className="row g-5 align-items-center">
                        <div className="col-lg-7">
                            <h2 className="fw-bold text-dark mb-4">Key Advantages of <span className="text-success">Germany</span></h2>
                            <ul className="list-unstyled">
                                
                                <li className="d-flex align-items-start mb-3">
                                    <span className="text-success fw-bold me-3" style={{ fontSize: '1.1rem' }}>1.</span>
                                    <span className="text-muted" style={{ fontSize: '1.05rem' }}>Little to no tuition fees at most public universities</span>
                                </li>
                                <li className="d-flex align-items-start mb-3">
                                    <span className="text-success fw-bold me-3" style={{ fontSize: '1.1rem' }}>2.</span>
                                    <span className="text-muted" style={{ fontSize: '1.05rem' }}>World leader in engineering, technology, and sciences</span>
                                </li>
                                <li className="d-flex align-items-start mb-3">
                                    <span className="text-success fw-bold me-3" style={{ fontSize: '1.1rem' }}>3.</span>
                                    <span className="text-muted" style={{ fontSize: '1.05rem' }}>18-month post-study work visa to find employment</span>
                                </li>
                                <li className="d-flex align-items-start mb-3">
                                    <span className="text-success fw-bold me-3" style={{ fontSize: '1.1rem' }}>4.</span>
                                    <span className="text-muted" style={{ fontSize: '1.05rem' }}>Strong economy offering excellent job prospects</span>
                                </li>
                                <li className="d-flex align-items-start mb-3">
                                    <span className="text-success fw-bold me-3" style={{ fontSize: '1.1rem' }}>5.</span>
                                    <span className="text-muted" style={{ fontSize: '1.05rem' }}>Central location in Europe for easy travel</span>
                                </li>
                                <li className="d-flex align-items-start mb-3">
                                    <span className="text-success fw-bold me-3" style={{ fontSize: '1.1rem' }}>6.</span>
                                    <span className="text-muted" style={{ fontSize: '1.05rem' }}>High quality of life with affordable living costs</span>
                                </li>
                            </ul>
                        </div>
                        <div className="col-lg-5">
                            <div className="card border-0 rounded-4 shadow-sm" style={{ backgroundColor: '#fcf6e3' }}>
                                <div className="card-body p-4 p-lg-5 text-center">
                                    <h4 className="fw-bold mb-4 text-dark">Your Pathway to Success in Germany</h4>
                    ...
                    <div className="row g-5">
                        <div className="col-md-6">
                            ...
                            <p className="text-muted" style={{ lineHeight: '1.8' }}>
                                In Germany, academic degrees are categorized into several levels. Foundation courses provide basic preparatory education. Bachelor degrees represent the completion of undergraduate studies, typically lasting three to four years. Master degrees follow, offering advanced, specialized knowledge usually attained within one to two years. Doctorate degrees are the highest academic qualifications, involving rigorous research.
                            </p>
                            <p className="text-muted" style={{ lineHeight: '1.8' }}>
                                The best courses in Germany offer diverse specializations, including Computer Science, Data Science, Business Analytics, Engineering, Health Informatics, and Artificial Intelligence. These programs provide cutting-edge education and prepare students for global opportunities.
                            </p>
                        </div>
                        <div className="col-md-6">
                            <h3 className="fw-bold text-dark mb-4">Undergraduate & Postgraduate Opportunities</h3>
                            <p className="text-muted" style={{ lineHeight: '1.8' }}>
                                Top-ranked universities in Germany offer high-quality education, producing graduates excelling in their fields. The programs provide academic versatility, allowing for customized study experiences with flexible courses and extracurricular activities.
                            </p>
                            <p className="text-muted" style={{ lineHeight: '1.8' }}>
                                These programs help students succeed both academically and professionally by sharpening their competitive edge and boosting their marketability. Graduating from an institution in Germany significantly enhances global career prospects and networking opportunities.
                            </p>
                        </div>
                    </div>
                </div>
            ...
            <section className="section-padding py-5 bg-white">
                <div className="container" style={{ maxWidth: '850px' }}>
                    <div className="text-center mb-5">
                        ...
                        <p className="text-muted">Find quick answers to common queries about studying in Germany</p>
                    </div>
