...
const StudyInAUSTRALIA = () => {
    ...
    const faqs = [
        {
                "q": "How long can I stay in Australia after graduation?",
                "a": "Depending on your qualification, the Temporary Graduate visa (subclass 485) allows you to live and work in Australia temporarily for 2 to 4 years after you finish your studies."
        },
        {
                "q": "Are scholarships available for international students?",
                "a": "Yes, the Australian Government and individual universities offer a wide range of scholarships, grants, and bursaries specifically for international students."
        },
        {
                "q": "Can I work while studying in Australia?",
                "a": "Yes, international students can work up to 48 hours a fortnight during the semester and full-time during semester breaks."
        },
        {
                "q": "What is the Overseas Student Health Cover (OSHC)?",
                "a": "OSHC is mandatory health insurance for international students in Australia. It helps cover the costs of medical and hospital care while studying."
        },
        {
                "q": "What is the Group of Eight (Go8)?",
                "a": "The Go8 is a coalition of Australia's leading research-intensive universities, known for their prestige and high global rankings."
        },
        {
                "q": "Are pathway programs available?",
                "a": "Yes, many institutions offer foundation or diploma pathway programs for students who don't meet the direct entry requirements for a bachelor's degree."
        },
        {
                "q": "What is the cost of living like in Australia?",
                "a": "The cost of living varies by city, but the government requires students to show access to around AUD 24,500 per year for living expenses."
        },
        {
                "q": "Do I need IELTS for an Australian student visa?",
                "a": "Yes, an English proficiency test like IELTS, PTE, or TOEFL is mandatory for securing an Australian student visa."
        }
];
    const faqsPerPage = 5;
        ...
        <div className="study-abroad-container bg-light min-vh-100 pb-5">
            ...
            <div className="container pt-4 pb-2">
                <div className="d-flex align-items-center text-muted small fw-medium">
                    ...
                    <FaChevronRight className="mx-2" style={{ fontSize: '0.7rem' }} />
                    <span className="text-dark fw-bold">Australia</span>
                </div>
            </div>
            ...
            <div className="container mt-2 mb-5">
                <div className="country-banner-box" 
                    style={{ 
                        backgroundImage: `url('${"https://images.unsplash.com/photo-1523482580672-f109ba8cb9be?auto=format&fit=crop&q=80&w=1920"}')`
                    }}>
                    <div className="country-banner-content">
                        ...
                        >
                            <h1 className="country-banner-title text-white">
                                Study in <span className="country-banner-accent">Australia</span>
                            </h1>
                ...
                <div className="container">
                    <div className="row align-items-center g-5">
                        <div className="col-lg-7">
                            <h2 className="fw-bold text-dark mb-4" style={{ fontSize: '2.5rem' }}>Begin Your Journey in <span className="text-success">Australia</span></h2>
                            <p className="text-muted mb-3" style={{ fontSize: '1.1rem', lineHeight: '1.8' }}>
                                Australia offers a diverse and vibrant education experience with top-tier universities, stunning landscapes, and a laid-back lifestyle. It is renowned for its strong focus on research and innovation.
                            </p>
                            <p className="text-muted mb-4" style={{ fontSize: '1.1rem', lineHeight: '1.8' }}>
                                The Australian education system is heavily regulated by the government to maintain premium standards. It emphasizes practical learning and industry connections, making graduates highly sought after in the global job market.
                            </p>
            ...
            <section className="section-padding py-5 bg-white">
                <div className="container">
                    <div className="row g-5 align-items-center">
                        <div className="col-lg-7">
                            <h2 className="fw-bold text-dark mb-4">Key Advantages of <span className="text-success">Australia</span></h2>
                            <ul className="list-unstyled">
                                
                                <li className="d-flex align-items-start mb-3">
                                    <span className="text-success fw-bold me-3" style={{ fontSize: '1.1rem' }}>1.</span>
                                    <span className="text-muted" style={{ fontSize: '1.05rem' }}>Seven of the top 100 universities in the world</span>
                                </li>
                                <li className="d-flex align-items-start mb-3">
                                    <span className="text-success fw-bold me-3" style={{ fontSize: '1.1rem' }}>2.</span>
                                    <span className="text-muted" style={{ fontSize: '1.05rem' }}>Excellent post-study work rights (up to 4 years)</span>
                                </li>
                                <li className="d-flex align-items-start mb-3">
                                    <span className="text-success fw-bold me-3" style={{ fontSize: '1.1rem' }}>3.</span>
                                    <span className="text-muted" style={{ fontSize: '1.05rem' }}>High minimum wage and permission to work while studying</span>
                                </li>
                                <li className="d-flex align-items-start mb-3">
                                    <span className="text-success fw-bold me-3" style={{ fontSize: '1.1rem' }}>4.</span>
                                    <span className="text-muted" style={{ fontSize: '1.05rem' }}>Incredible natural beauty and high standard of living</span>
                                </li>
                                <li className="d-flex align-items-start mb-3">
                                    <span className="text-success fw-bold me-3" style={{ fontSize: '1.1rem' }}>5.</span>
                                    <span className="text-muted" style={{ fontSize: '1.05rem' }}>Strong focus on technological innovation and research</span>
                                </li>
                                <li className="d-flex align-items-start mb-3">
                                    <span className="text-success fw-bold me-3" style={{ fontSize: '1.1rem' }}>6.</span>
                                    <span className="text-muted" style={{ fontSize: '1.05rem' }}>Safe, friendly, and diverse society</span>
                                </li>
                            </ul>
                        </div>
                        <div className="col-lg-5">
                            <div className="card border-0 rounded-4 shadow-sm" style={{ backgroundColor: '#fcf6e3' }}>
                                <div className="card-body p-4 p-lg-5 text-center">
                                    <h4 className="fw-bold mb-4 text-dark">Your Pathway to Success in Australia</h4>
                    ...
                    <div className="row g-5">
                        <div className="col-md-6">
                            ...
                            <p className="text-muted" style={{ lineHeight: '1.8' }}>
                                In Australia, academic degrees are categorized into several levels. Foundation courses provide basic preparatory education. Bachelor degrees represent the completion of undergraduate studies, typically lasting three to four years. Master degrees follow, offering advanced, specialized knowledge usually attained within one to two years. Doctorate degrees are the highest academic qualifications, involving rigorous research.
                            </p>
                            <p className="text-muted" style={{ lineHeight: '1.8' }}>
                                The best courses in Australia offer diverse specializations, including Computer Science, Data Science, Business Analytics, Engineering, Health Informatics, and Artificial Intelligence. These programs provide cutting-edge education and prepare students for global opportunities.
                            </p>
                        </div>
                        <div className="col-md-6">
                            <h3 className="fw-bold text-dark mb-4">Undergraduate & Postgraduate Opportunities</h3>
                            <p className="text-muted" style={{ lineHeight: '1.8' }}>
                                Top-ranked universities in Australia offer high-quality education, producing graduates excelling in their fields. The programs provide academic versatility, allowing for customized study experiences with flexible courses and extracurricular activities.
                            </p>
                            <p className="text-muted" style={{ lineHeight: '1.8' }}>
                                These programs help students succeed both academically and professionally by sharpening their competitive edge and boosting their marketability. Graduating from an institution in Australia significantly enhances global career prospects and networking opportunities.
                            </p>
                        </div>
                    </div>
                </div>
            ...
            <section className="section-padding py-5 bg-white">
                <div className="container" style={{ maxWidth: '850px' }}>
                    <div className="text-center mb-5">
                        ...
                        <p className="text-muted">Find quick answers to common queries about studying in Australia</p>
                    </div>
