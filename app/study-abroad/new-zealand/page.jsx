...
const StudyInNEWZEALAND = () => {
    ...
    const faqs = [
        {
                "q": "How long can I work in New Zealand post-graduation?",
                "a": "Depending on your level of study, you may be eligible for a Post-Study Work Visa that allows you to work for up to 3 years."
        },
        {
                "q": "Is New Zealand safe for international students?",
                "a": "Yes, New Zealand consistently ranks very highly on the Global Peace Index and is known for being extremely safe and welcoming to foreigners."
        },
        {
                "q": "Can I bring my partner with me?",
                "a": "In many cases, if you are studying a postgraduate qualification, your partner can apply for an open work visa for the same duration as your student visa."
        },
        {
                "q": "What is the teaching style like?",
                "a": "The teaching style encourages independent thinking, active participation, and hands-on learning rather than just rote memorization."
        },
        {
                "q": "Can I work while studying?",
                "a": "Yes, international students can generally work up to 20 hours a week during term time and full-time during scheduled holidays."
        },
        {
                "q": "What is the cost of living in New Zealand?",
                "a": "You need to show you have at least NZD 20,000 per year to support yourself while studying in New Zealand."
        },
        {
                "q": "Are scholarships available?",
                "a": "Yes, the New Zealand government and universities offer various scholarships specifically for international students."
        },
        {
                "q": "Do I need health insurance?",
                "a": "Yes, international students must have approved medical and travel insurance for the duration of their visa."
        }
];
    const faqsPerPage = 5;
        ...
        <div className="study-abroad-container bg-light min-vh-100 pb-5">
            ...
            <div className="container pt-4 pb-2">
                <div className="d-flex align-items-center text-muted small fw-medium">
                    ...
                    <FaChevronRight className="mx-2" style={{ fontSize: '0.7rem' }} />
                    <span className="text-dark fw-bold">New Zealand</span>
                </div>
            </div>
                    ...
                    <div className="country-banner-content">
                        ...
                        >
                            <h1 className="country-banner-title text-white">
                                Study in <span className="country-banner-accent">New Zealand</span>
                            </h1>
                ...
                <div className="container">
                    <div className="row align-items-center g-5">
                        <div className="col-lg-7">
                            <h2 className="fw-bold text-dark mb-4" style={{ fontSize: '2.5rem' }}>Begin Your Journey in <span className="text-success">New Zealand</span></h2>
                            <p className="text-muted mb-3" style={{ fontSize: '1.1rem', lineHeight: '1.8' }}>
                                New Zealand offers a progressive and safe learning environment. Its education system encourages students to ask questions and think critically, set against the backdrop of unparalleled natural beauty.
                            </p>
                            <p className="text-muted mb-4" style={{ fontSize: '1.1rem', lineHeight: '1.8' }}>
                                All eight of New Zealand's universities rank in the top 3% globally. The educational approach balances academic excellence with practical, hands-on learning, heavily supported by the government's rigorous quality assurance.
                            </p>
            ...
            <section className="section-padding py-5 bg-white">
                <div className="container">
                    <div className="row g-5 align-items-center">
                        <div className="col-lg-7">
                            <h2 className="fw-bold text-dark mb-4">Key Advantages of <span className="text-success">New Zealand</span></h2>
                            <ul className="list-unstyled">
                                
                                <li className="d-flex align-items-start mb-3">
                                    <span className="text-success fw-bold me-3" style={{ fontSize: '1.1rem' }}>1.</span>
                                    <span className="text-muted" style={{ fontSize: '1.05rem' }}>Globally recognized qualifications from top-ranked universities</span>
                                </li>
                                <li className="d-flex align-items-start mb-3">
                                    <span className="text-success fw-bold me-3" style={{ fontSize: '1.1rem' }}>2.</span>
                                    <span className="text-muted" style={{ fontSize: '1.05rem' }}>Post-study work rights allowing up to 3 years of employment</span>
                                </li>
                                <li className="d-flex align-items-start mb-3">
                                    <span className="text-success fw-bold me-3" style={{ fontSize: '1.1rem' }}>3.</span>
                                    <span className="text-muted" style={{ fontSize: '1.05rem' }}>Highly safe and peaceful country with low crime rates</span>
                                </li>
                                <li className="d-flex align-items-start mb-3">
                                    <span className="text-success fw-bold me-3" style={{ fontSize: '1.1rem' }}>4.</span>
                                    <span className="text-muted" style={{ fontSize: '1.05rem' }}>Incredible outdoor lifestyle and stunning landscapes</span>
                                </li>
                                <li className="d-flex align-items-start mb-3">
                                    <span className="text-success fw-bold me-3" style={{ fontSize: '1.1rem' }}>5.</span>
                                    <span className="text-muted" style={{ fontSize: '1.05rem' }}>Supportive learning environment for international students</span>
                                </li>
                                <li className="d-flex align-items-start mb-3">
                                    <span className="text-success fw-bold me-3" style={{ fontSize: '1.1rem' }}>6.</span>
                                    <span className="text-muted" style={{ fontSize: '1.05rem' }}>Pioneering research opportunities</span>
                                </li>
                            </ul>
                        </div>
                        <div className="col-lg-5">
                            <div className="card border-0 rounded-4 shadow-sm" style={{ backgroundColor: '#fcf6e3' }}>
                                <div className="card-body p-4 p-lg-5 text-center">
                                    <h4 className="fw-bold mb-4 text-dark">Your Pathway to Success in New Zealand</h4>
                    ...
                    <div className="row g-5">
                        <div className="col-md-6">
                            ...
                            <p className="text-muted" style={{ lineHeight: '1.8' }}>
                                In New Zealand, academic degrees are categorized into several levels. Foundation courses provide basic preparatory education. Bachelor degrees represent the completion of undergraduate studies, typically lasting three to four years. Master degrees follow, offering advanced, specialized knowledge usually attained within one to two years. Doctorate degrees are the highest academic qualifications, involving rigorous research.
                            </p>
                            <p className="text-muted" style={{ lineHeight: '1.8' }}>
                                The best courses in New Zealand offer diverse specializations, including Computer Science, Data Science, Business Analytics, Engineering, Health Informatics, and Artificial Intelligence. These programs provide cutting-edge education and prepare students for global opportunities.
                            </p>
                        </div>
                        <div className="col-md-6">
                            <h3 className="fw-bold text-dark mb-4">Undergraduate & Postgraduate Opportunities</h3>
                            <p className="text-muted" style={{ lineHeight: '1.8' }}>
                                Top-ranked universities in New Zealand offer high-quality education, producing graduates excelling in their fields. The programs provide academic versatility, allowing for customized study experiences with flexible courses and extracurricular activities.
                            </p>
                            <p className="text-muted" style={{ lineHeight: '1.8' }}>
                                These programs help students succeed both academically and professionally by sharpening their competitive edge and boosting their marketability. Graduating from an institution in New Zealand significantly enhances global career prospects and networking opportunities.
                            </p>
                        </div>
                    </div>
                </div>
            ...
            <section className="section-padding py-5 bg-white">
                <div className="container" style={{ maxWidth: '850px' }}>
                    <div className="text-center mb-5">
                        ...
                        <p className="text-muted">Find quick answers to common queries about studying in New Zealand</p>
                    </div>
