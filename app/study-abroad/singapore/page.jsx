...
const StudyInSINGAPORE = () => {
    ...
    const faqs = [
        {
                "q": "Can I work in Singapore after my studies?",
                "a": "Yes, graduates can apply for a Long Term Visit Pass (LTVP) for up to 1 year to seek employment in Singapore."
        },
        {
                "q": "What is the cost of living in Singapore?",
                "a": "Singapore is a premium destination, so living costs can be high (typically SGD 10,000 - 15,000 per year), but tuition is often lower than in Western countries."
        },
        {
                "q": "Are courses taught in English?",
                "a": "Yes, English is the primary language of instruction in Singapore's universities and is widely spoken throughout the country."
        },
        {
                "q": "Is it safe to study in Singapore?",
                "a": "Singapore is renowned as one of the safest cities in the world, with strictly enforced laws and very low crime rates."
        },
        {
                "q": "What is the Tuition Grant Scheme?",
                "a": "The Ministry of Education offers Tuition Grants to international students to subsidize tuition fees. In exchange, students sign a bond to work in Singapore for three years after graduation."
        },
        {
                "q": "Can I work part-time while studying?",
                "a": "International students at approved institutions can work up to 16 hours a week during term time and full-time during vacations, subject to certain conditions."
        },
        {
                "q": "Are scholarships available?",
                "a": "Yes, Singapore universities and external organizations offer merit-based scholarships that can significantly reduce tuition costs."
        },
        {
                "q": "Do I need a student pass?",
                "a": "Yes, all international students require a Student's Pass to pursue full-time studies in Singapore."
        }
];
    const faqsPerPage = 5;
        ...
        <div className="study-abroad-container bg-light min-vh-100 pb-5">
            ...
            <div className="container pt-4 pb-2">
                <div className="d-flex align-items-center text-muted small fw-medium">
                    ...
                    <FaChevronRight className="mx-2" style={{ fontSize: '0.7rem' }} />
                    <span className="text-dark fw-bold">Singapore</span>
                </div>
            </div>
            ...
            <div className="container mt-2 mb-5">
                <div className="country-banner-box" 
                    style={{ 
                        backgroundImage: `url('${"https://images.unsplash.com/photo-1525625293386-3f8f99389edd?auto=format&fit=crop&q=80&w=1920"}')`
                    }}>
                    <div className="country-banner-content">
                        ...
                        >
                            <h1 className="country-banner-title text-white">
                                Study in <span className="country-banner-accent">Singapore</span>
                            </h1>
                ...
                <div className="container">
                    <div className="row align-items-center g-5">
                        <div className="col-lg-7">
                            <h2 className="fw-bold text-dark mb-4" style={{ fontSize: '2.5rem' }}>Begin Your Journey in <span className="text-success">Singapore</span></h2>
                            <p className="text-muted mb-3" style={{ fontSize: '1.1rem', lineHeight: '1.8' }}>
                                Singapore is Asia's premier education hub, offering a unique blend of Eastern and Western cultures. It provides a highly safe, modern, and English-speaking environment with world-class institutions.
                            </p>
                            <p className="text-muted mb-4" style={{ fontSize: '1.1rem', lineHeight: '1.8' }}>
                                Singapore's universities frequently rank at the top in Asia and globally. The education system is renowned for its rigor and emphasis on math, science, and innovation, preparing students for the fast-paced global economy.
                            </p>
            ...
            <section className="section-padding py-5 bg-white">
                <div className="container">
                    <div className="row g-5 align-items-center">
                        <div className="col-lg-7">
                            <h2 className="fw-bold text-dark mb-4">Key Advantages of <span className="text-success">Singapore</span></h2>
                            <ul className="list-unstyled">
                                
                                <li className="d-flex align-items-start mb-3">
                                    <span className="text-success fw-bold me-3" style={{ fontSize: '1.1rem' }}>1.</span>
                                    <span className="text-muted" style={{ fontSize: '1.05rem' }}>Home to highly ranked global universities like NUS and NTU</span>
                                </li>
                                <li className="d-flex align-items-start mb-3">
                                    <span className="text-success fw-bold me-3" style={{ fontSize: '1.1rem' }}>2.</span>
                                    <span className="text-muted" style={{ fontSize: '1.05rem' }}>Extremely safe and clean global city</span>
                                </li>
                                <li className="d-flex align-items-start mb-3">
                                    <span className="text-success fw-bold me-3" style={{ fontSize: '1.1rem' }}>3.</span>
                                    <span className="text-muted" style={{ fontSize: '1.05rem' }}>Strategic business hub offering excellent networking</span>
                                </li>
                                <li className="d-flex align-items-start mb-3">
                                    <span className="text-success fw-bold me-3" style={{ fontSize: '1.1rem' }}>4.</span>
                                    <span className="text-muted" style={{ fontSize: '1.05rem' }}>English is the primary language of instruction</span>
                                </li>
                                <li className="d-flex align-items-start mb-3">
                                    <span className="text-success fw-bold me-3" style={{ fontSize: '1.1rem' }}>5.</span>
                                    <span className="text-muted" style={{ fontSize: '1.05rem' }}>Close proximity to India for easier travel</span>
                                </li>
                                <li className="d-flex align-items-start mb-3">
                                    <span className="text-success fw-bold me-3" style={{ fontSize: '1.1rem' }}>6.</span>
                                    <span className="text-muted" style={{ fontSize: '1.05rem' }}>Strong government investment in research and development</span>
                                </li>
                            </ul>
                        </div>
                        <div className="col-lg-5">
                            <div className="card border-0 rounded-4 shadow-sm" style={{ backgroundColor: '#fcf6e3' }}>
                                <div className="card-body p-4 p-lg-5 text-center">
                                    <h4 className="fw-bold mb-4 text-dark">Your Pathway to Success in Singapore</h4>
                    ...
                    <div className="row g-5">
                        <div className="col-md-6">
                            ...
                            <p className="text-muted" style={{ lineHeight: '1.8' }}>
                                In Singapore, academic degrees are categorized into several levels. Foundation courses provide basic preparatory education. Bachelor degrees represent the completion of undergraduate studies, typically lasting three to four years. Master degrees follow, offering advanced, specialized knowledge usually attained within one to two years. Doctorate degrees are the highest academic qualifications, involving rigorous research.
                            </p>
                            <p className="text-muted" style={{ lineHeight: '1.8' }}>
                                The best courses in Singapore offer diverse specializations, including Computer Science, Data Science, Business Analytics, Engineering, Health Informatics, and Artificial Intelligence. These programs provide cutting-edge education and prepare students for global opportunities.
                            </p>
                        </div>
                        <div className="col-md-6">
                            <h3 className="fw-bold text-dark mb-4">Undergraduate & Postgraduate Opportunities</h3>
                            <p className="text-muted" style={{ lineHeight: '1.8' }}>
                                Top-ranked universities in Singapore offer high-quality education, producing graduates excelling in their fields. The programs provide academic versatility, allowing for customized study experiences with flexible courses and extracurricular activities.
                            </p>
                            <p className="text-muted" style={{ lineHeight: '1.8' }}>
                                These programs help students succeed both academically and professionally by sharpening their competitive edge and boosting their marketability. Graduating from an institution in Singapore significantly enhances global career prospects and networking opportunities.
                            </p>
                        </div>
                    </div>
                </div>
            ...
            <section className="section-padding py-5 bg-white">
                <div className="container" style={{ maxWidth: '850px' }}>
                    <div className="text-center mb-5">
                        ...
                        <p className="text-muted">Find quick answers to common queries about studying in Singapore</p>
                    </div>
