    ...
    const faqs = [
        {
                ...
                "a": "The PGWP allows students who have graduated from an eligible Canadian designated learning institution to obtain an open work permit to gain valuable Canadian work experience."
        },
        {
                "q": "What are Co-op programs?",
                "a": "Co-operative education (co-op) programs combine academic studies with paid, relevant work experience in your field of study, giving you a competitive edge upon graduation."
        },
        {
                "q": "Is Canada safe for international students?",
                "a": "Yes, Canada is widely regarded as one of the safest and most peaceful countries in the world for international students, with a very welcoming multicultural society."
        },
        {
                "q": "Can studying in Canada lead to Permanent Residency?",
                "a": "Yes, Canada offers several pathways for international students to transition to permanent residency after they graduate and gain Canadian work experience."
        },
        {
                "q": "What is the Student Direct Stream (SDS)?",
                "a": "The SDS is an expedited study permit processing program for legal residents of certain countries (like India, China, etc.) if they meet specific financial and language requirements."
        },
        {
                "q": "Do I need French to study in Canada?",
                "a": "No, English is the primary language of instruction in most provinces except Quebec. However, knowing French can be an asset for immigration."
        },
        {
                "q": "Are Canadian degrees recognized globally?",
                "a": "Yes, Canadian degrees are equivalent to those from the US and Commonwealth countries and are highly respected globally."
        },
        {
                "q": "Can my spouse work while I study?",
                "a": "Yes, the spouse or common-law partner of an international student can apply for an open work permit, allowing them to work full-time in Canada."
        }
];
    const faqsPerPage = 5;
        ...
        <div className="study-abroad-container bg-light min-vh-100 pb-5">
            ...
            <div className="container pt-4 pb-2">
                <div className="d-flex align-items-center text-muted small fw-medium">
                    ...
                    <FaChevronRight className="mx-2" style={{ fontSize: '0.7rem' }} />
                    <span className="text-dark fw-bold">Canada</span>
                </div>
            </div>
            ...
            <div className="container mt-2 mb-5">
                <div className="country-banner-box" 
                    style={{ 
                        backgroundImage: `url('${"https://images.unsplash.com/photo-1517935706615-2717063c2225?auto=format&fit=crop&q=80&w=1920"}')`
                    }}>
                    <div className="country-banner-content">
                        ...
                        >
                            <h1 className="country-banner-title text-white">
                                Study in <span className="country-banner-accent">Canada</span>
                            </h1>
                ...
                <div className="container">
                    <div className="row align-items-center g-5">
                        <div className="col-lg-7">
                            <h2 className="fw-bold text-dark mb-4" style={{ fontSize: '2.5rem' }}>Begin Your Journey in <span className="text-success">Canada</span></h2>
                            <p className="text-muted mb-3" style={{ fontSize: '1.1rem', lineHeight: '1.8' }}>
                                Canada consistently ranks as one of the best countries in the world for quality of life and education. With its welcoming immigration policies and vibrant multicultural cities, it's a top destination for international students.
                            </p>
                            <p className="text-muted mb-4" style={{ fontSize: '1.1rem', lineHeight: '1.8' }}>
                                Canadian universities are known for their high standards and rigorous quality controls. A Canadian degree is globally recognized as equivalent to those from the US, UK, or Australia. The country also provides excellent co-op programs that integrate academic studies with paid work experience.
                            </p>
            ...
            <section className="section-padding py-5 bg-white">
                <div className="container">
                    <div className="row g-5 align-items-center">
                        <div className="col-lg-7">
                            <h2 className="fw-bold text-dark mb-4">Key Advantages of <span className="text-success">Canada</span></h2>
                            <ul className="list-unstyled">
                                
                                <li className="d-flex align-items-start mb-3">
                                    <span className="text-success fw-bold me-3" style={{ fontSize: '1.1rem' }}>1.</span>
                                    <span className="text-muted" style={{ fontSize: '1.05rem' }}>Highly affordable tuition fees compared to other top destinations</span>
                                </li>
                                <li className="d-flex align-items-start mb-3">
                                    <span className="text-success fw-bold me-3" style={{ fontSize: '1.1rem' }}>2.</span>
                                    <span className="text-muted" style={{ fontSize: '1.05rem' }}>Up to 3-year Post-Graduation Work Permit (PGWP)</span>
                                </li>
                                <li className="d-flex align-items-start mb-3">
                                    <span className="text-success fw-bold me-3" style={{ fontSize: '1.1rem' }}>3.</span>
                                    <span className="text-muted" style={{ fontSize: '1.05rem' }}>Clear pathways to Permanent Residency (PR)</span>
                                </li>
                                <li className="d-flex align-items-start mb-3">
                                    <span className="text-success fw-bold me-3" style={{ fontSize: '1.1rem' }}>4.</span>
                                    <span className="text-muted" style={{ fontSize: '1.05rem' }}>Consistently ranked among the safest countries in the world</span>
                                </li>
                                <li className="d-flex align-items-start mb-3">
                                    <span className="text-success fw-bold me-3" style={{ fontSize: '1.1rem' }}>5.</span>
                                    <span className="text-muted" style={{ fontSize: '1.05rem' }}>Excellent co-op programs and internship opportunities</span>
                                </li>
                                <li className="d-flex align-items-start mb-3">
                                    <span className="text-success fw-bold me-3" style={{ fontSize: '1.1rem' }}>6.</span>
                                    <span className="text-muted" style={{ fontSize: '1.05rem' }}>High quality of life and welcoming multicultural society</span>
                                </li>
                            </ul>
                        </div>
                        <div className="col-lg-5">
                            <div className="card border-0 rounded-4 shadow-sm" style={{ backgroundColor: '#fcf6e3' }}>
                                <div className="card-body p-4 p-lg-5 text-center">
                                    <h4 className="fw-bold mb-4 text-dark">Your Pathway to Success in Canada</h4>
                    ...
                    <div className="row g-5">
                        <div className="col-md-6">
                            ...
                            <p className="text-muted" style={{ lineHeight: '1.8' }}>
                                In Canada, academic degrees are categorized into several levels. Foundation courses provide basic preparatory education. Bachelor degrees represent the completion of undergraduate studies, typically lasting three to four years. Master degrees follow, offering advanced, specialized knowledge usually attained within one to two years. Doctorate degrees are the highest academic qualifications, involving rigorous research.
                            </p>
                            <p className="text-muted" style={{ lineHeight: '1.8' }}>
                                The best courses in Canada offer diverse specializations, including Computer Science, Data Science, Business Analytics, Engineering, Health Informatics, and Artificial Intelligence. These programs provide cutting-edge education and prepare students for global opportunities.
                            </p>
                        </div>
                        <div className="col-md-6">
                            <h3 className="fw-bold text-dark mb-4">Undergraduate & Postgraduate Opportunities</h3>
                            <p className="text-muted" style={{ lineHeight: '1.8' }}>
                                Top-ranked universities in Canada offer high-quality education, producing graduates excelling in their fields. The programs provide academic versatility, allowing for customized study experiences with flexible courses and extracurricular activities.
                            </p>
                            <p className="text-muted" style={{ lineHeight: '1.8' }}>
                                These programs help students succeed both academically and professionally by sharpening their competitive edge and boosting their marketability. Graduating from an institution in Canada significantly enhances global career prospects and networking opportunities.
                            </p>
                        </div>
                    </div>
                </div>
            ...
            <section className="section-padding py-5 bg-white">
                <div className="container" style={{ maxWidth: '850px' }}>
                    <div className="text-center mb-5">
                        ...
                        <p className="text-muted">Find quick answers to common queries about studying in Canada</p>
                    </div>
