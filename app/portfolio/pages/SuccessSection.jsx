...
import { FaBuilding, FaGraduationCap, FaQuoteLeft } from "react-icons/fa";
    ...
    <section className="success" id="success">
      <div className="success__container">
        <div className="success__header">
          <h2>Success <span className="text-green">Stories</span></h2>
          ...
          {SUCCESS_STORIES.map((s) => (
            <div key={s.id} className="success__card">
              <div className="success__card-top">
                ...
                <div className="success__info">
                  ...
                  <div className="success__company">
                    <FaBuilding className="company__icon" />
                    {s.company}
                  </div>
                </div>
              </div>
              ...
              <div className="success__batch">
                <FaGraduationCap className="batch__icon" />
                {s.batch}
              </div>
